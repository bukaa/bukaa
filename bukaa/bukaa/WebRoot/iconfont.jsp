...
<html>
	...
	<body class="gray-bg">
				...
				<div class="col-sm-12">
					<div class="tabs-container">
	                    <ul class="nav nav-tabs">
	                        <li class="active">
	                        	<a data-toggle="tab" href="#tab-web" aria-expanded="true"><i class="fa fa-fonticons"></i>Web应用程序</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-hand" aria-expanded="false"><i class="fa fa-hand-paper-o"></i>手型</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-transport" aria-expanded="false"><i class="fa fa-car"></i>交通运输</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-gender" aria-expanded="false"><i class="fa fa-mars"></i>性别</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-filetype" aria-expanded="false"><i class="fa fa-file"></i>文件类型</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-animation" aria-expanded="false"><i class="fa fa-cog"></i>加载动画</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-form" aria-expanded="false"><i class="fa fa-check-square-o"></i>表单</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-payment" aria-expanded="false"><i class="fa fa-cc-visa"></i>支付</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-chart" aria-expanded="false"><i class="fa fa-bar-chart"></i>统计</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-currency" aria-expanded="false"><i class="fa fa-cny"></i>货币</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-editor" aria-expanded="false"><i class="fa fa-align-center"></i>文本编辑器</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-directional" aria-expanded="false"><i class="fa fa-arrows"></i>方向</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-player" aria-expanded="false"><i class="fa fa-play"></i>视频播放</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-brand" aria-expanded="false"><i class="fa fa-amazon"></i>品牌</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-medical" aria-expanded="false"><i class="fa fa-ambulance"></i>医疗</a>
	                        </li>
	                        <li class="">
	                        	<a data-toggle="tab" href="#tab-glyphicons" aria-expanded="false"><i class="glyphicon glyphicon-euro"></i>Glyphicons</a>
	                        </li>
	                    </ul>
	                    <div class="tab-content">
	                        ...
	                        <!-- 手型图标 -->
	                        <div id="tab-hand" class="tab-pane">
	                            <div class="panel-body">
	                                <div class="ibox float-e-margins">
	                                	<div class="row fontawesome-icon-list">
			                                <div class="fa-hover col-md-3 col-sm-4"><a href="#hand-rock-o"><i class="fa fa-hand-grab-o"></i> hand-grab-o <span class="text-muted">(alias)</span></a></div>
	                        ...
	                        <!-- 性别图标 -->
	                        <div id="tab-gender" class="tab-pane">
	                            <div class="panel-body">
	                                <div class="ibox float-e-margins">
	                                	<div class="row fontawesome-icon-list">
	                        ...
	                        <!-- 文件类型图标 -->
	                        <div id="tab-filetype" class="tab-pane">
	                            <div class="panel-body">
	                                <div class="ibox float-e-margins">
	                                	<div class="row fontawesome-icon-list">
	                        ...
	                        <!-- 方向图标 -->
	                        <div id="tab-directional" class="tab-pane">
	                            <div class="panel-body">
	                                <div class="ibox float-e-margins">
	                                	<div class="row fontawesome-icon-list">
	                        ...
	                        <!-- 医疗图标 -->
	                        <div id="tab-medical" class="tab-pane">
	                            <div class="panel-body">
	                                <div class="ibox float-e-margins">
	                                	<div class="row fontawesome-icon-list">
			                                <div class="fa-hover col-md-3 col-sm-4"><a href="#ambulance"><i class="fa fa-ambulance"></i> ambulance</a></div>
	                        ...
	                        <!-- glyphicons图标 -->
	                        <div id="tab-glyphicons" class="tab-pane">
	                            <div class="panel-body">
	                                <div class="ibox float-e-margins">
		...
		<script src="${ctx}/static/pro/js/iconfont.js"></script>
	</body>
</html>