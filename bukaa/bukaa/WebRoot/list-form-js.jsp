...
<script type="text/javascript" src="${ctx}/static/h+/4.1.0/js/plugins/iCheck/icheck.min.js"></script>
...
<script type="text/javascript" src="${ctx}/static/h+/4.1.0/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
